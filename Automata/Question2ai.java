...
class Question2ai
{
    ...
    public static void main(String[] args) 
    {
        ...
        A.alphabet_size=2; // {0,1}
        A.n_states=8; // {q0,q1,q2,q3,q4,q5,q6,q6,q7}
        A.delta=new int[][]{
            {0, 1, 1}, {1, 1, 0}, {0, 0, 7}, {1, -1, 7},
            {7, -1, 2}, {7, 1, 2}, {2, 0, 4}, {2, 1, 5},
            {3, -1, 4}, {3, 1, 5}, {4, 0, 5}, {4, -1, 6},
            {5, 0, 5}, {5, 1, 5}, {6, -1, 6}, {6, 1, 5}
        };
        
        A.initial_state=0; // initial state is q0
        A.final_states=new int[]{5,6}; // final state is q5,q6
    ...
    static FSAe e_remove(FSAe A)
    {
        ...
        //
        // TODO (make sure the new transition relation is named trRel)
